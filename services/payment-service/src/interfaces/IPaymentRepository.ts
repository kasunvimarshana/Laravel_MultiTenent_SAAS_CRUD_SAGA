...
export interface CreatePaymentData extends ProcessPaymentParams { _id: string; status: PaymentStatus; }
export interface UpdatePaymentData { status?: PaymentStatus; transactionId?: string; errorCode?: string; errorMessage?: string; processedAt?: Date; refundedAt?: Date; }
