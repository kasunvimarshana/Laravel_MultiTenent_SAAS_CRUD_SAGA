export interface PublishOptions { exchange?: string; routingKey?: string; persistent?: boolean; }
export interface SubscribeOptions { queue: string; prefetch?: number; noAck?: boolean; }
